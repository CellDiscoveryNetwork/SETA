...
### What SETA Does Exceptionally Well
...
`DCATS`, `speckle`, and `muscat`. `SETA` aims to provide 
a more comprehensive set of tools for compositional analysis with a focus
on simpler models that respect the compositional constraint.
