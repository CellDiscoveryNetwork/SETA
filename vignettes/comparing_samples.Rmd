...
if (!requireNamespace("SeuratObject", quietly = TRUE) ||
  ...
  knitr::knit_exit()  # Skip vignette gracefully
}
```
...
##TODO TKTK setaDistances uses `dist` -- is it OK to call it aitchison distances? see -> https://search.r-project.org/CRAN/refmans/robCompositions/html/aDist.html
```{r}
